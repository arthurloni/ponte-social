  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:scale-105 shadow-strong hover:shadow-action transform transition-spring",
        action: "bg-action text-action-foreground hover:bg-action/90 shadow-action hover:shadow-strong transform hover:scale-105 transition-spring",
        warm: "bg-gradient-warm text-white hover:scale-105 shadow-medium hover:shadow-action transform transition-spring",
      },
      size: {
